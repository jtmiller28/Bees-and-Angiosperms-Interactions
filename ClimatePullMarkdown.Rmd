...
```{r eval=FALSE, include=FALSE}
write.csv(reordered_plant_df, "/media/jt-miller/T7/CCBER/ClimateNAPulls/cali-extended-regions-plant-pull.csv")
```
...
```{r eval=FALSE, include=FALSE}
write.csv(reordered_bees_df, "/media/jt-miller/T7/CCBER/ClimateNAPulls/cali-extended-regions-bee-pull.csv")
```
...
Create the .csv for the data pull 
```{r}
write.csv(combined_occurrences, "/media/jt-miller/T7/CCBER/ClimateNAPulls/cali-extended-regions-combined-occurrence-pull.csv")
```
